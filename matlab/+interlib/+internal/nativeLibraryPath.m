function path = nativeLibraryPath()
...
error('interlib:NativeLibraryMissing', ...
    'Could not locate the interlib shared library. Set INTERLIB_NATIVE_LIBRARY or build the Rust library into target/matlab/debug, target/matlab/release, target/debug, or target/release.');
end
